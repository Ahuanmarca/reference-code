# CS50 Solutions with Java

Exercises from CS50, adapted to Java.

**This is not expert Java code, I adapted these exercises while learning Java from tutorials!**

## Example

### Plurality.java distribution code

Implement the `vote()` and `printWinner()` functions.
...
public class Plurality {
    ...
    public static Boolean vote(String name) {
        ...
        // TODO: If vote is valid, record the vote and return true
        return false;
    }

    public static void printWinner() {

        // TODO: Print the winner, or the winners if there are more than one
        return;
    }
...
class Helpers {
    ...
    // Checks if a string represents an int by trying to use Integer.parseInt()
